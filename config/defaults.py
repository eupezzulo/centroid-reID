...
# 'LAST_STRIDE' of the backbone to use
_C.MODEL.LAST_STRIDE = 1
# 'PRETRAIN_PATH' specifies the pre-trained weights of the model
_C.MODEL.PRETRAIN_PATH = ''
# Use ImageNet or LuPerson pretrained model to initialize backbone, or use self trained model to initialize the whole model
# Options: 'imagenet', 'luperson' or 'self'
...
_C.INPUT.PADDING = 10
# Random probability for random color dropout
_C.INPUT.RCD_PROB = 0.5
# Random probability for color jitter
...
# If test with centroid, options: 'yes', 'no'
_C.TEST.WITH_CENTROIDS = 'no'
